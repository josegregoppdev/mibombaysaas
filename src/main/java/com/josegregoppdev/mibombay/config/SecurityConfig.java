    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/combo/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/customer/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/supplier/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/purchase/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/movement/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/sale/**").hasAnyRole("ADMIN", "CASHIER", "SUPER_ADMIN")
